...
available in Section 3.2 of the textbook. You can learn about experimental
...
- The Campaign.java in src/main/java/labeight/experiment has exactly 0 of the `Add Your Name Here` fragment
- The Campaign.java in src/main/java/labeight/experiment has exactly 0 of the `TODO` fragment
- The Campaign.java in src/main/java/labeight/experiment has exactly 0 of the `println` fragment
- The Campaign.java in src/main/java/labeight/experiment has exactly 1 of the `package labeight` fragment
- The Experiment.java in src/main/java/labeight/experiment has at least 2 single-line Java comment(s)
- The Experiment.java in src/main/java/labeight/experiment has at least 4 multiple-line Java comment(s)
- The Experiment.java in src/main/java/labeight/experiment has at least 4 of the `println(` fragment
- The Experiment.java in src/main/java/labeight/experiment has exactly 0 of the `Add Your Name Here` fragment
- The Experiment.java in src/main/java/labeight/experiment has exactly 0 of the `TODO` fragment
- The Experiment.java in src/main/java/labeight/experiment has exactly 1 of the `package labeight` fragment
- The ResultsTable.java in src/main/java/labeight/data has at least 12 multiple-line Java comment(s)
- The ResultsTable.java in src/main/java/labeight/data has at least 2 single-line Java comment(s)
- The ResultsTable.java in src/main/java/labeight/data has exactly 0 of the `Add Your Name Here` fragment
- The ResultsTable.java in src/main/java/labeight/data has exactly 0 of the `TODO` fragment
- The ResultsTable.java in src/main/java/labeight/data has exactly 0 of the `println` fragment
- The ResultsTable.java in src/main/java/labeight/data has exactly 1 of the `double ratio =` fragment
- The ResultsTable.java in src/main/java/labeight/data has exactly 1 of the `package labeight` fragment
- The RunCampaign.java in src/main/java/labeight/experiment has at least 1 single-line Java comment(s)
- The RunCampaign.java in src/main/java/labeight/experiment has at least 3 of the `println(` fragment
- The RunCampaign.java in src/main/java/labeight/experiment has at least 5 multiple-line Java comment(s)
- The RunCampaign.java in src/main/java/labeight/experiment has exactly 0 of the `Add Your Name Here` fragment
- The RunCampaign.java in src/main/java/labeight/experiment has exactly 0 of the `TODO` fragment
- The RunCampaign.java in src/main/java/labeight/experiment has exactly 1 of the `package labeight` fragment
- The SinglyLinkedList.java in src/main/java/labeight/list has exactly 0 of the `Add Your Name Here` fragment
- The SinglyLinkedList.java in src/main/java/labeight/list has exactly 0 of the `TODO` fragment
- The SinglyLinkedList.java in src/main/java/labeight/list has exactly 0 of the `public abstract class` fragment
- The SinglyLinkedList.java in src/main/java/labeight/list has exactly 1 of the `package labeight` fragment
- The SinglyLinkedList.java in src/main/java/labeight/list has exactly 1 of the `public String toString(` fragment
- The TestResultsTable.java in src/test/java/labeight has exactly 0 of the `Add Your Name Here` fragment
- The TestResultsTable.java in src/test/java/labeight has exactly 0 of the `TODO` fragment
- The TestResultsTable.java in src/test/java/labeight has exactly 1 of the `package labeight` fragment
- The command `gradle -q --console plain run` executes correctly
- The command `gradle build` executes correctly
- The command `gradle test` executes correctly
- The file Campaign.java exists in the src/main/java/labeight/experiment directory
- The file Experiment.java exists in the src/main/java/labeight/experiment directory
- The file ResultsTable.java exists in the src/main/java/labeight/data directory
- The file RunCampaign.java exists in the src/main/java/labeight/experiment directory
- The file SinglyLinkedList.java exists in the src/main/java/labeight/list directory
- The file TestResultsTable.java exists in the src/test/java/labeight directory
- The file reflection.md exists in the writing directory
- The reflection.md in writing has at least 5 of the `code` tag
- The reflection.md in writing has at least 800 word(s) in total
- The reflection.md in writing has at least 9 paragraph(s)
- The reflection.md in writing has exactly 0 of the `Add Your Name Here` fragment
- The reflection.md in writing has exactly 12 of the `heading` tag
...
```
        ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Passed 48/48 (100%) of checks for cs101-F2019-lab8! ┃
        ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
```
git remote add download git@github.com:Allegheny-Computer-Science-101-F2019/cs101-F2019-lab8-starter.git
```
...
5](https://github.com/Allegheny-Computer-Science-101-F2019/cs101-F2019-lab8-starter)
repository and [raise an
issue](https://github.com/Allegheny-Computer-Science-101-F2019/cs101-F2019-lab8-starter/issues).
